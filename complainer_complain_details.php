...
<head>
  ...
  <?php
    ...
    $query="select c_id,description,evidence,inc_status,pol_status from complaint natural join user where c_id='$c_id' and u_id='$u_id'";
