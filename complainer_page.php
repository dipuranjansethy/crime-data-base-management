...
if(isset($_POST['s'])){
    ...
    if($var>=0)
    {
      ...
      $comp="INSERT into complaint(a_no,location,type_crime,d_o_c,description,evidence) values('$a_no','$location','$type_crime','$d_o_c','$description','$evidence')";
      mysqli_select_db($conn,"crime_portal"); 
...
<div class="video" style="margin-top: 5%"> 
	<div class="center-container">
		 <div class="bg-agile">
          ...
          <div class="top-w3-agile" style="color: gray">
					evidence
						<textarea  name="evidence" rows="20" cols="50" placeholder="paste google drive link of evidences here" onfocusout="f1()" id="evi" required></textarea>
					</div>
...
<div style="position: relative;
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;">&copy <b>Crime Portal 2023</b></h4>
</div>
